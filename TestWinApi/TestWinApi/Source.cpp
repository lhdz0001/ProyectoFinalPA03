...
void agregar_especies(HWND hwnd)
{
	...
	SendDlgItemMessage(hwnd, CMB_ESPECIE, CB_ADDSTRING, NULL, (LPARAM)"Perro");
	SendDlgItemMessage(hwnd, CMB_ESPECIE, CB_ADDSTRING, NULL, (LPARAM)"Gato");
	SendDlgItemMessage(hwnd, CMB_ESPECIE, CB_ADDSTRING, NULL, (LPARAM)"Caballo");
	SendDlgItemMessage(hwnd, CMB_ESPECIE, CB_ADDSTRING, NULL, (LPARAM)"Ave");
	SendDlgItemMessage(hwnd, CMB_ESPECIE, CB_ADDSTRING, NULL, (LPARAM)"Roedor");
	SendDlgItemMessage(hwnd, CMB_ESPECIE, CB_ADDSTRING, NULL, (LPARAM)"Reptil");
